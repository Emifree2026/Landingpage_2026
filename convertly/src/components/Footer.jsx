    ...
    const Footer = () => {
      ...
      const footerLinks = {
        ...
        Legal: [
          ...
          { name: 'General Terms (GTC)', href: '/terms' }
        ]
      };

      const socialLinks = [
        { name: 'LinkedIn', icon: Linkedin, href: 'https://www.linkedin.com/company/emifree-gmbh/' },
        { name: 'Email', icon: Mail, href: 'mailto:info@emifree.com' }
      ];
